    ...
    */
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let failure : [String : String] = [
            "description" : "Failed to initialize the application's saved data",
        ...
        do {
            ...
            dict[NSLocalizedDescriptionKey] = failure["description"]! as String
            dict[NSLocalizedFailureReasonErrorKey] = failure["reason"]! as String
